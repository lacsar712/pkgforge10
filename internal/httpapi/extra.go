...
import (
	...
	"example.com/pkgforge/internal/backup"
	"example.com/pkgforge/internal/model"
	"example.com/pkgforge/internal/policy"
	"example.com/pkgforge/internal/report"
	"example.com/pkgforge/internal/validate"
	"example.com/pkgforge/internal/workflow"
)
...
func (s *Server) handleBackup(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Disposition", "attachment; filename=pkgforge.zip")
	_, _ = w.Write(b)
}
